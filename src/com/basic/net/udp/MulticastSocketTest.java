...
/**
 * 使用MulticastSocket实现了一个基于广播的多人聊天室，
 * 程序只需要一个MulticastSocket，两条线程，其中MulticastSocket既用于发送，也用于接收，
 * 其中一条线程分别负责接受用户键盘输入，并向MulticastSocket发送数据，
 * 另一条线程则负责从MulticastSocket中读取数据
 *
...
public class MulticastSocketTest implements Runnable {
    ...
    public void init() {
        try {
            ...
            // 因为该MulticastSocket对象需要接收，所以有指定的端口
