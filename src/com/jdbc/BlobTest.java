...
/**
 * 图片“上传”——将图片保存到数据库，并在右边的列表框显示图片的名字，
 * 当用户双击列表框的图片名时，左边窗口将显示该图片（根据选中的ID从数据库里查找图片，并将其显示出来）
 */
...
class ExtensionFileFilter extends FileFilter
{
    ...
    // 继承FileFilter类必须实现的抽象方法，返回该文件过滤器的描述文件
